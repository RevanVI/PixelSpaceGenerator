...
@export var linear_gradient_tex: TextureRect
@export var contant_gradient_tex: TextureRect
@export var lightened_contant_gradient_tex: TextureRect
@export var darkened_contant_gradient_tex: TextureRect
...
func update_colors() -> void:
	...
	(linear_gradient_tex.texture as GradientTexture1D).gradient.colors = output_colors
	(contant_gradient_tex.texture as GradientTexture1D).gradient.colors = output_colors
	...
	(lightened_contant_gradient_tex.texture as GradientTexture1D).gradient.colors = lightened
	(darkened_contant_gradient_tex.texture as GradientTexture1D).gradient.colors = darkened
