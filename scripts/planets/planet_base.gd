...
func set_values(id: int, gen_seed: int, mode: ColorHelpers.ColorMode, palette: GradientTexture2D, pixel_scale: int) -> void:
	Log.info(name, "Planet id " + str(id) + " set_values start, seed: " + str(gen_seed))
	...
	set_color_mode(mode)
	show()
	Log.info(name, "Planet id " + str(id) + " set_values end")
...
func set_color_mode(mode: ColorHelpers.ColorMode) -> void:
	Log.info(name, "Planet id " + str(planet_id) + " set_color_mode " + str(mode))
	color_mode = mode
...
func set_colors(colors_1: PackedColorArray, colors_2: PackedColorArray) -> void:
	Log.info(name, "Planet id " + str(planet_id) + " set_colors")
